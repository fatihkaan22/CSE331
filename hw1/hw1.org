#+TITLE: CSE 331 Computer Organizations Homework 1
...
:END:
  ...
  *Today*:  Wafer cost \rightarrow 10 000 $
  
  Wafer cost will decrease 20% every year 
  
  *4 years later*:  Wafer cost \rightarrow $10000 \times 0.8^4 = 4096 $
...
\quad
  ...
  *4 years later*:  Yield will be \rightarrow $0.9^4 = 0.6561$ of the inital yield, which is: $0.6561 \times 0.8 = 0.52488$
